  ...
  return (
    <DashboardLayout role="user">
      <div className="space-y-6">
        ...
        <p className="text-gray-500">يمكنك التواصل مع فريقنا بخصوص أي طلب من طلباتك</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-100">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-sm text-gray-400">ستظهر المحادثات بعد أن يتم تعيين طلبك لموظف</p>
            </div>
          ) : (
            <div className="divide-y divide-gray-50">
              {rfqs.map((rfq) => (
                <Link
                  key={rfq.id}
                  href={`/dashboard/rfqs/${rfq.id}?tab=chat`}
